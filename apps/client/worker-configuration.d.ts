/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 43fbb8be1c9b78cbd2a50f782cbf1533)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "API_HOST" | "VITE_API_URL">> {}
}
